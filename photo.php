 ...
 <!-- Brand and toggle get grouped for better mobile display -->
   ...
   <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        ...
        <li class="current_page"><a href="photo.php">Photogallery</a></li>
...
<div class="about_banner">
  <div class="container">
    <h2>PHOTOGALLERY</h2>
    <span class="breadcrumbs"><a href="index.php"><i class="fa fa-home home_1"></i></a><span>Photogallery/Photos</span></span>
  </div>
</div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="images/gallery1.jpg" alt="IDEAS" style="width:100%;">
      ...
      <div class="item">
        <img src="images/photo1.jpg" alt="INNOVATIONS" style="width:100%;">
        <div class="carousel-caption">
          <h3>Department of Applied Science</h3>
          
        </div>
      </div>
    
      <div class="item">
        <img src="images/photo2.jpg" alt="New York" style="width:100%;">
        <div class="carousel-caption">
          <h3>Department of Applied Science</h3>
        </div>
      </div>
      <div class="item">
        <img src="images/gallery2.jpg" alt="INNOVATIONS" style="width:100%;">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="images/gallery3.jpg" alt="New York" style="width:100%;">
        <div class="carousel-caption">
          <h3>Cathod Ray Tube</h3>
        </div>
      </div>
