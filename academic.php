...
<div class="header">
		<div class="container">
			<div class="col-sm-12 logo">
			  <h1><a href="index.html"><span class="highlight">D</span>epartment of Applied Science</a></h1>
			</div>
        ...
        <ul class="nav navbar-nav nav_1">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu drop_menu" role="menu">
                ...
                <li><a href="commitees.html">Commitees</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu drop_menu" role="menu">
                <li><a href="pos.html">PEOs & POs</a></li>
                <li><a href="sources.html">Short Sources</a></li>                
              </ul>
            </li>
...
<div class="about_banner">
  <div class="container">
    ...
    <span class="breadcrumbs"><a href="index.html"><i class="fa fa-home home_1"></i></a><span>Calender/Academic Calender</span></span>
  </div>
</div>
  ...
  <div class="col-md-9 column-15">
     <h6>Testimonials</h6>
       <div class="module_container">
        ...
        <h5 class="item_title1">annoying consequences</h5>
        ...
        <h5 class="item_title1">But I must explain</h5>
        <p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco"</p>
        <h5 class="item_title1">Quis autem vel eum </h5>
        <p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.</p>
        <h5 class="item_title1">nostrum exercitationem ullam</h5>
        <p class="last_4">The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.</p>
        </div>
